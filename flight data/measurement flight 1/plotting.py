...
csv_file = "measurement flight 1.txt"
...
co2_stat_error = df_column_to_list(df, "CO2 / ppm_smooth_9_3_staticerror_0.00364_6.3")
...
co2_rt_corr_error = df_column_to_list(df, "CO2 / ppm_smooth_9_3_staticerror_0.00364_6.3_with_complete_rt_error")
so2_smooth = df_column_to_list(df, "SO2 / ppm_smooth_9_3")
so2_stat_error = df_column_to_list(df, "SO2 / ppm_smooth_9_3_staticerror_0.0323_0.26")
...
so2_rt_corr_error = df_column_to_list(df, "SO2 / ppm_smooth_9_3_staticerror_0.0323_0.26_with_complete_rt_error")
...
ratio_error_rt_smooth__rt_smooth = df_column_to_list(df, "ratio_error_CO2 / ppm_smooth_9_3_rt_corrected_40_shifted_11_smooth_9_3_CO2 / ppm_smooth_9_3_staticerror_0.00364_6.3_with_complete_rt_error_SO2 / ppm_smooth_9_3_rt_corrected_8_smooth_9_3_SO2 / ppm_smooth_9_3_staticerror_0.0323_0.26_with_complete_rt_error_420")
ratio_error_rt__rt = df_column_to_list(df, "ratio_error_CO2 / ppm_smooth_9_3_rt_corrected_40_shifted_11_CO2 / ppm_smooth_9_3_staticerror_0.00364_6.3_with_complete_rt_error_SO2 / ppm_smooth_9_3_rt_corrected_8_SO2 / ppm_smooth_9_3_staticerror_0.0323_0.26_with_complete_rt_error_420")
ratio_error_rt__smooth = df_column_to_list(df, "ratio_error_CO2 / ppm_smooth_9_3_rt_corrected_40_shifted_11_CO2 / ppm_smooth_9_3_staticerror_0.00364_6.3_with_complete_rt_error_SO2 / ppm_smooth_9_3_SO2 / ppm_smooth_9_3_staticerror_0.0323_0.26_420")
ratio_error_rt_smooth__smooth = df_column_to_list(df, "ratio_error_CO2 / ppm_smooth_9_3_rt_corrected_40_shifted_11_smooth_9_3_CO2 / ppm_smooth_9_3_staticerror_0.00364_6.3_with_complete_rt_error_SO2 / ppm_smooth_9_3_SO2 / ppm_smooth_9_3_staticerror_0.0323_0.26_420")
...
plot_graph_three_in_one_plot(timelist, co2_smooth, co2_stat_error, co2_rt_corr_shifted, co2_rt_corr_error, co2_rt_corr_shifted_smooth, co2_rt_corr_error, title="1. measurement flight", first_data_name="CO2 (S300)", second_data_name="CO2 r.c. smooth", third_data_name="CO2 smartGAS smooth", x_axis_name="time", y_axis_name="CO2 / ppm")
plot_graph_three_in_one_plot(timelist, so2_smooth, so2_stat_error, so2_rt_corr, so2_rt_corr_error, so2_rt_corr_smooth, so2_rt_corr_error, title="1. measurement flight", first_data_name="SO2 (AS)", second_data_name="SO2 response corrected", third_data_name="SO2 r.c. smooth", x_axis_name="time", y_axis_name="SO2 / ppm")

plot_graph_with_2_subplots_2_data_in_upper_one_data_in_lower(timelist, co2_rt_corr_shifted_smooth, co2_rt_corr_error, timelist, so2_rt_corr_smooth, so2_rt_corr_error, timelist, ratio_rt_smooth__rt_smooth, ratio_error_rt_smooth__rt_smooth, title="1. measurement flight", first_data_name="CO2 r.c. smooth", second_data_name="SO2 (AS) r.c. smooth", third_data_name="CO2/SO2 ratio", x_axis_name="time", y1_1_axis_name="CO2 / ppm", y1_2_axis_name="SO2 / ppm", y2_axis_name="CO2/SO2")
plot_graph_with_2_subplots_2_data_in_upper_one_data_in_lower(timelist, co2_rt_corr_shifted, co2_rt_corr_error, timelist, so2_rt_corr, so2_rt_corr_error, timelist, ratio_rt__rt, ratio_error_rt__rt, title="1. measurement flight", first_data_name="CO2 r.c.", second_data_name="SO2 (AS) r.c.", third_data_name="CO2/SO2 ratio", x_axis_name="time", y1_1_axis_name="CO2 / ppm", y1_2_axis_name="SO2 / ppm", y2_axis_name="CO2/SO2")
plot_graph_with_2_subplots_2_data_in_upper_one_data_in_lower(timelist, co2_rt_corr_shifted, co2_rt_corr_error, timelist, so2_smooth, so2_stat_error, timelist, ratio_rt__smooth, ratio_error_rt__smooth, title="1. measurement flight", first_data_name="CO2 r.c.", second_data_name="SO2 (AS) smooth", third_data_name="CO2/SO2 ratio", x_axis_name="time", y1_1_axis_name="CO2 / ppm", y1_2_axis_name="SO2 / ppm", y2_axis_name="CO2/SO2")
plot_graph_with_2_subplots_2_data_in_upper_one_data_in_lower(timelist, co2_rt_corr_shifted_smooth, co2_rt_corr_error, timelist, so2_smooth, so2_stat_error, timelist, ratio_rt_smooth__smooth, ratio_error_rt_smooth__smooth, title="1. measurement flight", first_data_name="CO2 r.c. smooth", second_data_name="SO2 (AS) smooth", third_data_name="CO2/SO2 ratio", x_axis_name="time", y1_1_axis_name="CO2 / ppm", y1_2_axis_name="SO2 / ppm", y2_axis_name="CO2/SO2")
