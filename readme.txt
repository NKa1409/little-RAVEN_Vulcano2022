...
"flight data" folder contains the data for measurement flight 1 & 2 as well as the validation flight.
"photoacoustic CO2 sensor" folder contains the data for the testing of the photoacustic SCD41 sensor during a lab test and a test flight on vulcano.
